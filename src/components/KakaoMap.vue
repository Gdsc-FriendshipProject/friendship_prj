<template>
    <div>
        <div>
                <b-button v-b-toggle.sidebar-footer>경유지 확인</b-button>
                <!-- <br> -->
                <!-- <br> -->
                <b-sidebar 
                    id="sidebar-footer" 
                ...
                >
                    <template #footer="{ hide }">
                        <div class="d-flex bg-dark text-light align-items-center px-3 py-2">
                            ...
                            <b-button size="sm" @click="save(), hide(), toast('b-toaster-bottom-center', true)">Save</b-button>

                        </div>
                    </template>
                <div class="px-3 py-2">
                    <b-badge variant="dark" style="padding-top:4.3%"><h4>START</h4></b-badge>
                    <br>
                    <br>
                    <h3 v-for="(name,index) in placeName" v-bind:key="index">
                        ↓
                        <br>
                        <br>
